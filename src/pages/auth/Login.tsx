...
const Login = () => {
  ...
  const getVerificationIcon = (result: VerificationResult) => {
    if (result.isValid) return <CheckCircle className="w-4 h-4 text-green-600" />;
  ...
  const getVerificationBadge = (score: number, licenseVerified: boolean) => {
    ...
    if (licenseVerified && score >= 70) {
      return { text: "Verified Doctor", color: "bg-[#C9A6A1]", icon: Star };
    }
    if (licenseVerified) {
      return { text: "License Verified", color: "bg-green-600", icon: CheckCircle };
    }
    if (score >= 50) {
  ...
  const TestDoctorIds = () => (
    <Alert className="mb-4 border-[#E3D8C8] bg-[#FDFBF7]">
      <AlertTriangle className="w-4 h-4 text-[#C9A6A1]" />
      <AlertDescription>
        <div className="text-sm">
          <p className="font-medium text-[#5D4E47] mb-2">Test Doctor License Numbers:</p>
          <div className="grid grid-cols-1 gap-1 text-[#5D4E47] text-xs">
            <div><code className="bg-[#F0EBDB] px-1 rounded">MH12345678</code> - Dr. Rajesh Kumar (MCI)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">TN98765432</code> - Dr. Meera Nair (State Council)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">GJ11223344</code> - Dr. Arjun Patel (State Council)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">UP55667788</code> - Dr. Sita Gupta (State Council)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">RJ99887766</code> - Dr. Vikram Singh (State Council)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">AYU/KA/789012</code> - Dr. Lakshmi Rao (AYUSH)</div>
            <div><code className="bg-[#F0EBDB] px-1 rounded">NMC/2022001234</code> - Dr. Rohit Joshi (NMC)</div>
          </div>
        </div>
      </AlertDescription>
    </Alert>
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-4">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-[#5D4E47]">Basic Information</h3>
              <p className="text-sm text-[#5D4E47]/70">Let's start with your basic details</p>
            </div>
            
            <div>
              <Label htmlFor="name" className="text-[#5D4E47]">Full Name *</Label>
              <Input
                id="name"
                name="name"
                type="text"
                ...
                disabled={isLoading}
                className="border-[#E3D8C8] focus:border-[#C9A6A1] focus:ring-[#C9A6A1]"
              />
            </div>
            <div>
              <Label htmlFor="email" className="text-[#5D4E47]">Email *</Label>
              <Input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <Label htmlFor="password" className="text-[#5D4E47]">Password *</Label>
              <Input
                id="password"
                name="password"
                type="password"
            ...
            <div>
              <Label htmlFor="confirmPassword" className="text-[#5D4E47]">Confirm Password *</Label>
              <Input
                id="confirmPassword"
      ...
      case 2:
        return (
          <div className="space-y-4">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold flex items-center justify-center gap-2 text-[#5D4E47]">
                <Shield className="w-5 h-5 text-[#C9A6A1]" />
                License Verification
              </h3>
              <p className="text-sm text-[#5D4E47]/70">Verify your medical credentials</p>
            </div>
            
            <TestDoctorIds />
            
            <div>
              <Label htmlFor="medicalCouncil" className="text-[#5D4E47]">Medical Council *</Label>
              <Select 
                value={verificationData.medicalCouncil}
                onValueChange={(value) => handleVerificationChange('medicalCouncil', value)}
              >
                <SelectTrigger className="border-[#E3D8C8] focus:border-[#C9A6A1] focus:ring-[#C9A6A1]">
            ...
            <div>
              <Label htmlFor="licenseNumber" className="text-[#5D4E47]">Medical License Number *</Label>
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="whitespace-nowrap bg-[#C9A6A1] hover:bg-[#B89691] text-white"
                >
                  {isVerifyingLicense ? (
                    <>
            ...
            <div>
              <Label htmlFor="medicalDegree" className="text-[#5D4E47]">Medical Degree *</Label>
              <Select 
            ...
            <div>
              <Label htmlFor="graduationYear" className="text-[#5D4E47]">Graduation Year *</Label>
              <Input
                id="graduationYear"
                type="number"
                min="1980"
      ...
      case 3:
        return (
          <div className="space-y-4">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold flex items-center justify-center gap-2 text-[#5D4E47]">
                <Leaf className="w-5 h-5 text-[#C9A6A1]" />
                Ayurvedic Expertise
              </h3>
              <p className="text-sm text-[#5D4E47]/70">Tell us about your Ayurvedic specialization</p>
            </div>
            
            <div>
              <Label htmlFor="ayurvedicCertification" className="text-[#5D4E47]">Ayurvedic Certification</Label>
              <Input
            ...
            <div>
              <Label className="text-[#5D4E47]">Specialization Areas</Label>
                ...
                {[
                  ...
                  <div key={spec} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-[#E3D8C8] data-[state=checked]:bg-[#C9A6A1] data-[state=checked]:border-[#C9A6A1]"
                    />
                    <Label htmlFor={spec} className="text-sm text-[#5D4E47]">{spec}</Label>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <Label htmlFor="traditionalTraining" className="text-[#5D4E47]">Traditional Training Background</Label>
              <Textarea
            ...
            <div>
              <Label htmlFor="yearsOfExperience" className="text-[#5D4E47]">Years of Experience *</Label>
              <Input
      ...
      case 4:
        return (
          <div className="space-y-4">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-[#5D4E47]">Practice Details</h3>
              <p className="text-sm text-[#5D4E47]/70">Complete your professional profile</p>
            </div>
            
            <div>
              <Label htmlFor="clinicName" className="text-[#5D4E47]">Clinic/Practice Name *</Label>
              <Input
                id="clinicName"
            ...
            <div>
              <Label htmlFor="clinicAddress" className="text-[#5D4E47]">Clinic Address</Label>
              <Textarea
                id="clinicAddress"
            ...
            <div>
              <Label htmlFor="consultationFee" className="text-[#5D4E47]">Consultation Fee (₹)</Label>
              <Input
                id="consultationFee"
                type="number"
                min="0"
            ...
            <div>
              <Label className="text-[#5D4E47]">Languages Spoken</Label>
              <div className="grid grid-cols-2 gap-2 mt-2">
                {[
                  ...
                  <div key={language} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-[#E3D8C8] data-[state=checked]:bg-[#C9A6A1] data-[state=checked]:border-[#C9A6A1]"
                    />
                    <Label htmlFor={language} className="text-sm text-[#5D4E47]">{language}</Label>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <Label className="text-[#5D4E47]">Special Conditions Treated</Label>
                ...
                {[
                  ...
                  <div key={condition} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-[#E3D8C8] data-[state=checked]:bg-[#C9A6A1] data-[state=checked]:border-[#C9A6A1]"
                    />
                    <Label htmlFor={condition} className="text-sm text-[#5D4E47]">{condition}</Label>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <Label className="text-[#5D4E47]">Consultation Modes Available</Label>
              <div className="grid grid-cols-2 gap-2 mt-2">
                {[
                  ...
                  <div key={mode} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-[#E3D8C8] data-[state=checked]:bg-[#C9A6A1] data-[state=checked]:border-[#C9A6A1]"
                    />
                    <Label htmlFor={mode} className="text-sm text-[#5D4E47]">{mode}</Label>
                  </div>
                ))}
              </div>
            </div>
            
            <div className="mt-6 p-4 bg-[#FDFBF7] rounded-lg border border-[#E3D8C8]">
              <h4 className="font-medium mb-3 text-[#5D4E47]">Profile Verification Status</h4>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[#5D4E47]">Verification Score:</span>
                  <div className="flex items-center gap-2">
                    <div className="w-24 bg-[#E3D8C8] rounded-full h-2">
                      <div 
                        className="bg-[#C9A6A1] h-2 rounded-full transition-all duration-300"
                        style={{ width: `${calculateVerificationScore()}%` }}
                      />
                    </div>
                    <span className="text-sm font-medium text-[#5D4E47]">{calculateVerificationScore()}%</span>
                  </div>
                </div>
  ...
  return (
    <div className="min-h-screen bg-[#F0EBDB] flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-[#FDFBF7] border-[#E3D8C8]">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center mb-2">
            <Leaf className="w-8 h-8 text-[#C9A6A1] mr-2" />
            <CardTitle className="text-2xl font-bold text-[#5D4E47]">
              Ayurvedic Health
            </CardTitle>
          </div>
          <CardDescription className="text-[#5D4E47]/70">
            {isSignup ? "Create your account" : "Sign in to your account"} as a{" "}
            <span className="font-semibold capitalize text-[#C9A6A1]">{role}</span>
            {role === "doctor" && isSignup && (
              <div className="mt-2 text-xs text-[#5D4E47]/60">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            {role === "doctor" && isSignup && (
              <div className="mb-6">
                <div className="flex items-center justify-between text-xs text-[#5D4E47]/60 mb-2">
                  <span>Basic Info</span>
                  <span>License</span>
                  <span>Expertise</span>
                  <span>Practice</span>
                </div>
                <div className="w-full bg-[#E3D8C8] rounded-full h-2">
                  <div 
                    className="bg-[#C9A6A1] h-2 rounded-full transition-all duration-300"
            ...
            {isSignup && role === "doctor" && (
              <div className="flex justify-between pt-4">
                <Button
                  ...
                  className="border-[#E3D8C8] text-[#5D4E47] hover:bg-[#F0EBDB]"
                >
                  Back
                </Button>
                ...
                {currentStep < 4 ? (
                  <Button
                    ...
                    onClick={handleNext}
                    disabled={isLoading}
                    className="bg-[#C9A6A1] hover:bg-[#B89691] text-white"
                  >
                    Next
                  </Button>
                ) : (
                  <Button type="submit" disabled={isLoading} className="bg-[#C9A6A1] hover:bg-[#B89691] text-white">
                    {isLoading ? (
                      <>
                        <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                        Creating Account...
            ...
            {(!isSignup || role === "patient") && (
              <Button type="submit" className="w-full bg-[#C9A6A1] hover:bg-[#B89691] text-white" disabled={isLoading}>
                {isLoading ? (
                  <>
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" />
            ...
            <div className="text-center pt-4">
              <button
                ...
                className="text-sm text-[#C9A6A1] hover:text-[#B89691] underline"
                disabled={isLoading}
              >
                {isSignup
